...
export default function SettingsPage() {
  ...
  const sections = isAdmin ? adminSections : empSections;
  ...
  // ── Thème section (partagé admin + employé) ───────────────────────────────
  const ThemeSection = () => (
    <div style={cardStyle}>
  ...
  if (!isAdmin) {
    ...
    return (
      <div style={{ minHeight: "100vh", background: "var(--bg, #111)", color: "var(--text, #fff)", paddingBottom: "80px" }}>
        <div style={{ padding: "20px 16px 12px", borderBottom: "1px solid var(--border, #222)", marginBottom: "16px" }}>
          <h1 style={{ fontSize: "20px", fontWeight: 800, margin: 0, color: "var(--primary, #D4AF37)" }}>
            ⚙️ Réglages
          </h1>
          {emp && (
          ...
          {empSections.map((s) => (
            <button
              ...
              style={{
                ...
                padding: "8px 14px",
                borderRadius: "20px",
                border: activeSection === s.id ? "none" : "1px solid var(--border, #333)",
                background: activeSection === s.id
                  ? "linear-gradient(135deg, #D4AF37, #B8963E)"
                  : "transparent",
                color: activeSection === s.id ? "#000" : "var(--text-muted, #aaa)",
        ...
        <div style={{ padding: "0 16px" }}>
          ...
          {activeSection === "pin" && (
            <div style={cardStyle}>
              <h2 style={{ fontSize: "16px", fontWeight: 700, marginTop: 0, marginBottom: "16px", color: "var(--text)" }}>
                🔒 Changer mon PIN
              </h2>
              <p style={{ fontSize: "13px", color: "var(--text-muted)", marginBottom: "16px" }}>
                Contactez votre administrateur pour changer votre PIN.
              </p>
              <div style={{
          ...
          {activeSection === "paye" && (
            <div style={cardStyle}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: "32px", fontWeight: 900, color: "var(--primary, #D4AF37)" }}>
                  ${emp?.hourlyRate ?? 0}/h
                </div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg, #111)", color: "var(--text, #fff)", paddingBottom: "80px" }}>
      ...
      <div style={{ padding: "20px 16px 12px", borderBottom: "1px solid var(--border, #222)", marginBottom: "12px" }}>
        <h1 style={{ fontSize: "20px", fontWeight: 800, margin: 0, color: "var(--primary, #D4AF37)" }}>
          ⚙️ Réglages Admin
        </h1>
      </div>
      ...
      <div style={{ padding: "0 16px" }}>
        ...
        {activeSection === "company" && (
          <div style={cardStyle}>
            ...
            <button style={btnGold} onClick={save}>{saved ? "✅ Sauvegardé!" : "💾 Sauvegarder"}</button>
          </div>
        )}
            ...
            {employees.length === 0 ? (
              ...
              employees.map((emp) => (
                <div key={emp.id} style={{
                  ...
                  padding: "14px", background: "var(--surface)", borderRadius: "10px",
        ...
        {activeSection === "numbering" && (
          <div style={cardStyle}>
            ...
            <div style={{ background: "var(--surface)", borderRadius: "8px", padding: "12px", marginBottom: "12px", fontSize: "13px", color: "var(--text-muted)" }}>
              Exemple: <strong style={{ color: "var(--primary, #D4AF37)" }}>
        ...
        {activeSection === "danger" && (
          <div style={{ ...cardStyle, borderColor: "#7f1d1d" }}>
            ...
            <p style={{ fontSize: "13px", color: "var(--text-muted)", marginBottom: "16px" }}>Ces actions sont irréversibles. Procédez avec prudence.</p>
